...
final class OrderMapperTest extends TestCase
{
    ...
    public function testZeroRateLineMapsToZeroRatedVatCategory(): void
    {
        ...
        // (exonéré) — invoice-core (rules.ts, BR-E-10) exige un motif
        // d'exonération pour "E", jamais fourni par ce mapper, ce qui
        // provoquait un 422 systématique (pending_retry inépuisable,
        // facture jamais émise). "Z" n'exige aucun motif.
        $fixture = $this->loadFixture('b2c-sans-siren.json');
        [$firstName, $lastName] = explode(' ', $fixture['buyer']['name'], 2);
        $order = $this->buildOrderFromFixture(
            $fixture,
        ...
        $this->addProductLine($order, id: 1, name: 'Produit à taux zéro', quantity: 1, unitPrice: 10.0, rate: 0.0);
