...
/**
 * Client HTTP vers l'API Factelec — contrat côté connecteur (design §2,
 * contrat amont autoritaire, IDENTIQUE au connecteur PrestaShop) :
 ...
 *     (leçon it.1 : un simple /health ne prouve pas que la clé API est
...
final class FactelecClient
{
     ...
     * de la page de réglages WooCommerce. Endpoint AUTHENTIFIÉ
     * (TenantAuthGuard côté API) : 200 prouve à la fois que l'URL est
     * joignable ET que la clé API est valide ; 401 signale spécifiquement
     * une clé invalide/révoquée (message BO dédié) ; toute autre issue
     * (panne réseau, timeout, statut inattendu) reste un échec générique.
     * Ne lève JAMAIS — c'est l'appelant qui décide du message affiché à
     * partir du résultat typé.
     */
