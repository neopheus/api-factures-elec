 ...
 * suffit pas dès lors que la sonde utilise un endpoint AUTHENTIFIÉ
 * (GET /invoices?limit=1, leçon it.1 : un simple /health ne prouve pas que
 * la clé API est valide, seulement que l'URL répond) : un échec peut venir
 * soit d'une clé API invalide (401), soit d'une panne réseau/URL
